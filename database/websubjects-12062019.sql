...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2019 at 12:06 PM
...
(23, 'Lớp học 2', 24, 2, '2019-04-21', '2020-04-21', 2, 0),
...
--
ALTER TABLE `comment`
  MODIFY `ID_Comment` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `topic`
  MODIFY `ID_Topic` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
COMMIT;
